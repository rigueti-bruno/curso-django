...
SECRET_KEY = 'django-insecure-&n3*c@c(grje@4uqlv=x!=dpdugn%m=+#)0qqvic1z)qfxz(w#'
...
STATICFILES_DIRS = [
    BASE_DIR / 'base_static', # inclui o caminho para arquivos estaticos globais do projeto
]
